...
const itunesScrobbler = Object.freeze({
  ...
  description: (
    <>
      ...
      <Link href="https://last.fm" target="_blank" rel="noreferrer">Last.fm</Link>
      &nbsp;scrobbling app for macOS. Scrobbles from iTunes and Music apps, as
      well as VOX. The app is managed entirely from the top-bar of macOS.

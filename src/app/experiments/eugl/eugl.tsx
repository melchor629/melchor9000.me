...
export default function Eugl() {
  ...
  const [engine, setEngine] = useState<PromiseResolvedType<ReturnType<typeof createEngine>> | null>(null)
  ...
  const onCustomImageChange = useCallback((imageUrl: string) => {
  ...
  return (
    <>
      <div
        style={{ width: '100%', height: '100lvh', marginTop: '-48px', position: 'relative', backgroundColor: '#121212' }}
        ref={setContainer}
      />
